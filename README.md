...
<h3>Intro</h3>
<ul>
  <li>A RESTful API is the Application Program Interface that uses HTTP requests (GET, PUT, POST or DELETE) to help client (web or mobile app) to interact with server's database - inserting data into a database or retriving data from a database.</li>
  <li>With RESTful API in Flask, I can define the way of interacting between client and server using HTTP requests what describes below schema:</li>
</ul>
